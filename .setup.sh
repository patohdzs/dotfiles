#!/bin/bash
# Run this scripts to set up your dotfiles!
# curl -Lks https://raw.githubusercontent.com/patohdzs/dotfiles/main/.setup.sh | bash

# Useful env variables
DOTFILES=.dotfiles
REMOTE=git@github.com:patohdzs/dotfiles.git
